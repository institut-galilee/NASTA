...
if __name__ == "__main__":
  ...
  try:
      opts, args = getopt.getopt(sys.argv[1:],"h", ['help']) # Note that argument s indicates which classroom you wants to target
  except getopt.GetoptError:
      print ('\nUsage : python3 getnbpeople.py') 
      sys.exit(2)
  for opt, arg in opts:
    if opt in ("-h","--help"):
      print ('Usage : python3 getnbpeople.py')
      sys.exit()
